<template>
  <div class="display-6 text-primary">Simple Form</div>
    ...
    <div class="row g-0">
      ...
      <div class="col-12 col-md-6">
        <div class="card-body p-3 p-md-4 p-xl-5">
          ...
          <div class="alert alert-danger" role="alert" v-if="error && error.length">
          ...
          <form action="#!">
            <div class="row gy-3 gy-md-4 overflow-hidden">
              ...
              <div class="col-12">
                <div class="d-grid">
                  <button class="btn bsb-btn-xl btn-primary" v-on:click="login">
                    Log in now
                  </button>
                </div>
              </div>
  ...
  methods: {
    login(event) {
      ...
      if (this.form.remember === "") {
        this.error.push("Remember is required");
      }
